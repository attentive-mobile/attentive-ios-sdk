...
- (void)testSaveObject {
  ...
  XCTAssertTrue([@"savedValue"
      isEqualToString:[persistentStorage readStringForKey:@"someKey"]]);
}
...
- (void)testSaveObject_givenValidString_saves {
  ...
  XCTAssertTrue(
      [VALUE isEqualToString:[persistentStorage readStringForKey:KEY]]);
}
...
- (void)testSaveObject_overwriteWithDifferentValue_savesDifferentValue {
  ...
  XCTAssertTrue(
      [@"newValue" isEqualToString:[persistentStorage readStringForKey:KEY]]);
}
