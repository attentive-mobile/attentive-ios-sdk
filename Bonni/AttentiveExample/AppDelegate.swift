...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func initializeAttentiveSdk() {
        ...
        // Opt in to SDK-driven push deep link navigation (default is false so upgrading hosts
        // that already navigate on the broadcasts don't double-navigate; the inbox equivalent,
        // automaticallyOpensInboxDeepLinks, is already on by default). Bonni has no
