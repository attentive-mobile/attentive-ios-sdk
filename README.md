...
```ruby
target 'MyApp' do
  pod 'attentive-ios-sdk', '2.0.1-beta.3'
end
```
...
SPM: Manually select https://github.com/attentive-mobile/attentive-ios-sdk in Xcode package dependency UI and then specify branch name: beta/2.0.1-beta.3
...
See the [Bonni App](https://github.com/attentive-mobile/attentive-ios-sdk/tree/beta/2.0.1-beta.3/Bonni) for a sample of how the push integration works.
