...
class InboxViewModel: ObservableObject {
    ...
    /// otherwise by opening `actionURL` via `UIApplication` (unless the host opted out via
    ...
    func click(_ message: Message) {
        ...
        // Host opted out of SDK-initiated navigation (`automaticallyOpensInboxDeepLinks = false`)
