...
// Your unique identifier for the user - this should be consistent across the
// user's lifetime, for example a database id
...
// Key-value pairs of custom identifier names and values (both NSStrings) to
...
- (void)validateIdentifiers:(nonnull NSDictionary *)identifiers {
  [ATTNParameterValidation
      verifyStringOrNil:identifiers[IDENTIFIER_TYPE_CLIENT_USER_ID]
              inputName:IDENTIFIER_TYPE_CLIENT_USER_ID];
  [ATTNParameterValidation verifyStringOrNil:identifiers[IDENTIFIER_TYPE_PHONE]
                                   inputName:IDENTIFIER_TYPE_PHONE];
  [ATTNParameterValidation verifyStringOrNil:identifiers[IDENTIFIER_TYPE_EMAIL]
                                   inputName:IDENTIFIER_TYPE_EMAIL];
  [ATTNParameterValidation
      verifyStringOrNil:identifiers[IDENTIFIER_TYPE_SHOPIFY_ID]
              inputName:IDENTIFIER_TYPE_SHOPIFY_ID];
  [ATTNParameterValidation
      verifyStringOrNil:identifiers[IDENTIFIER_TYPE_KLAVIYO_ID]
              inputName:IDENTIFIER_TYPE_KLAVIYO_ID];
  [ATTNParameterValidation
      verify1DStringDictionaryOrNil:identifiers
